...
export default async function AdminPage() {
  ...
  return (
    <DashboardShell
      ...
      description="Admins can review account health, local listing status, and pending marketplace activity from one private workspace."
    >
      <div className="grid gap-6">
        ...
        <Card className="bg-white shadow-sm dark:bg-zinc-950">
          <CardHeader>
            ...
            <CardDescription>
              Review vehicle listings and status from the private admin portal.
            </CardDescription>
          </CardHeader>
          <CardContent>
